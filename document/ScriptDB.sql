...
DECLARE v_price_m3, v_price_shift, v_price_wait, v_price_location, v_price_location_shift, v_convert_value DOUBLE;
...
AND ct.construction_id=p_construction_id AND p.pump_type=p_pump_type;
...
OPEN c_data;		
        START_LOOP: LOOP
			...
			END;
		END LOOP START_LOOP; 
        SET total_revenue=v_location_revenue+v_m3_revenue+v_wait_revenue+v_shift_revenue;
